...
public class CompanyServiceImpl implements CompanyService {
    ...
    public Map<String, Object> updateInternship(int id, Map<String, Object> body) {
        ...
        try {
            ...
            try {
                jdbcTemplate.update("UPDATE internships SET title=?, required_skills=?, work_mode=?, location=?, stipend=?, openings=? WHERE id=?",
                        title, skills, mode, loc, stipend, openings, id);
            } catch (Exception ex) {}
        }
